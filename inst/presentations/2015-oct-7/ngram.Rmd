...
```r
vignette("ngram-guide", package="ngram")
```
...
* The first 3000 nucleic acids in the DNA sequence of Saccharomyces cerevisiae are available here  [http://tinyurl.com/p73a8wk](http://tinyurl.com/p73a8wk).  How many 2-grams are there?  3-grams?  What is the ratio of 2-grams to characters?  (Hint:  see `?charsplitter`)
